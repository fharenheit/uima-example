...
public class PersonTitleAnnotator extends CasAnnotator_ImplBase {
	 ...
	 *
	 * @param aCAS CAS containing document text and previously discovered annotations, and to which new
	 ...
	 *
	 * @param aCAS      the CAS in which to create new annotations
	 * @param aText     the substring of the document text within which to search
	 * @param aBeginPos the position of this substring relative to the start of the document
	 */
	 ...
	 * @param aText      the substring of the document text within which to search
	 * @param aBeginPos  the position of this substring relative to the start of the document
	 * @param aTitleType the type of title to look for. This becomes the value of the <code>Kind</code>
	 *                   feature.
	 ...
	 *
	 * @param aCAS       the CAS in which to create the annotation
	 * @param aBeginPos  the begin position of the annotation relative to the start of the document
	 * @param aEndPos    the end position of the annotation relative to the start of the document. (Note that,
	 ...
	 * @param aTitleType the type of person title. This becomes the value of the <code>Kind</code> feature.
	 */
